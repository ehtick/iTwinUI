var l=Object.defineProperty;var d=(o,a,e)=>a in o?l(o,a,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[a]=e;var s=(o,a,e)=>(d(o,typeof a!="symbol"?a+"":a,e),e);(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function e(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerpolicy&&(i.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?i.credentials="include":t.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(t){if(t.ep)return;t.ep=!0;const i=e(t);fetch(t.href,i)}})();class u extends HTMLElement{constructor(){super();s(this,"changeTheme",({target:{value:e}})=>{const n=e.endsWith("-hc"),t=n?e.split("-")[0]:e;document.documentElement.dataset.iuiTheme=t,document.documentElement.dataset.iuiContrast=n?"high":void 0,document.documentElement.className=`iui-theme-${t}`,this.shadowRoot.querySelector("#theme-color-scheme").innerHTML=`
      :host {
